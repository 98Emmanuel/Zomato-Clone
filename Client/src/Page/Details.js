...
class Details extends React.Component{
    constructor(){
        ...
        this.state = {
            restaurant: [],
            resId: undefined,
            galleryModal : false,  // the state is false means its closed (initially)
            menuModal : false,
            menu : []
        }
    }
    ...
    componentDidMount() {
        ...
        axios({
            url: `http://localhost:5500/rest/${restuarant}`,
            method: 'get',
    ...
    addItems = (index, operationType) => {
        var total = 0; // initially, let the total be 0
        const items = [...this.state.menu]; // spread operator
    ...
    render(){
            ...
            <div>
                ...
                <div className="container">
                    <div className="bannerCover">
                        <img src={restaurant.thumb} alt="details1" className="banner" />
                    ...
                    <div className="tabs">
                        <div className="tab">
                            ...
                            <div className="content">
                                ...
                                <div className="value">
                                    {restaurant && restaurant.Cuisine && restaurant.Cuisine.map(cu => `${cu.name}, `)} {/*Because we have an object within an object*/}
                                </div>
       ...
       <div>
                        <Carousel showIndicators={false} showThumbs={false} showStatus={false}>
                            ...
                            <div>
                                <img src="./images/1.png" className="gallery_img" /> {/*An extra image added*/}
